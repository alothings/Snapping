...
public class RecipientsActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mMediaUri = getIntent().getData(); // for the File message
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		mSendMenuItem = menu.getItem(0);  //parameter is the position of the item (since only one, value is 0)
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()){
			case android.R.id.home:
				...
				return true;
			case R.id.action_send:        // Parse  the  object  to create  message  for  sending 
	...
	protected ParseObject createMessage() {
		...
		else { //almost ready to create a parse file. First need to resize image.
